...
public class MixinBlock
{
    ...
    public void isFullCube(final IBlockState blockState, final CallbackInfoReturnable<Boolean> callbackInfoReturnable) {
        try {
            if (Client.hNxW.qHPF((Class<BoatPhase>)dDTQ.class).IuiN()) {
